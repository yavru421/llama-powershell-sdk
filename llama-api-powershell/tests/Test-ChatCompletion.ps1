# Test script for Llama API PowerShell SDK - Basic Chat Completion
# This test checks if the chat completion endpoint is reachable and returns a valid response.
